 ...
 * Generated at: 2025-12-17T20:23:10.707Z
...
DescriptionFunctions["current_item_param_2"] = DescriptionRuntime.memoize(function(ctx) {
  const level = DescriptionRuntime.get(ctx.currentItem, "level");
  const baseData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[1].parameters[1]");
  const upgData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[1].upgrade.increment");
  const upgCount = (Number(level) || 0) - (Number(1) || 0);
  const upgValue = (Number(upgData) || 0) * (Number(upgCount) || 0);
  const itemData = (Number(baseData) || 0) + (Number(upgValue) || 0);
  return DescriptionRuntime.formatModInt(itemData);
...
DescriptionFunctions["current_item_increment_param_1"] = DescriptionRuntime.memoize(function(ctx) {
  const itemData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[0].upgrade.increment");
  return DescriptionRuntime.formatModInt(itemData);
}, 5);
...
DescriptionFunctions["current_item_increment_param_2"] = DescriptionRuntime.memoize(function(ctx) {
  const itemData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[1].upgrade.increment");
  return DescriptionRuntime.formatModInt(itemData);
}, 5);
...
DescriptionFunctions["current_item_param_1_int"] = DescriptionRuntime.memoize(function(ctx) {
  const itemData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[0].parameters[3]");
  return DescriptionRuntime.formatModInt(itemData);
}, 5);
...
DescriptionFunctions["current_item_param_1_int_modifier"] = DescriptionRuntime.memoize(function(ctx) {
  const level = DescriptionRuntime.get(ctx.currentItem, "level");
  const baseData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[0].parameters[3]");
  const upgData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[1].parameters[3]");
  const upgCount = (Number(level) || 0) - (Number(1) || 0);
  const upgValue = (Number(upgData) || 0) * (Number(upgCount) || 0);
  const itemData = (Number(baseData) || 0) + (Number(upgValue) || 0);
  return DescriptionRuntime.formatModInt(itemData);
...
DescriptionFunctions["current_item_param_2_modifier"] = DescriptionRuntime.memoize(function(ctx) {
  const itemData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[1].parameters[3]");
  return DescriptionRuntime.formatModPercentNumeric(itemData);
}, 5);
...
DescriptionFunctions["current_item_shamaniac_soul_gemwood_mask_artifact_param"] = DescriptionRuntime.memoize(function(ctx) {
  const viewRadius = DescriptionRuntime.get(ctx.currentHero, "heroStat.viewRadius");
  const heroRadius = (Number(viewRadius) || 0) * (Number("3") || 0);
...
DescriptionFunctions["current_item_shamaniac_soul_gemwood_mask_artifact_param_1"] = DescriptionRuntime.memoize(function(ctx) {
  const itemData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[0].parameters[2]");
  return DescriptionRuntime.formatModInt(itemData);
}, 5);
...
DescriptionFunctions["current_item_shamaniac_soul_gemwood_mask_artifact_param_2"] = DescriptionRuntime.memoize(function(ctx) {
  const itemData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[1].parameters[2]");
  return DescriptionRuntime.formatModInt(itemData);
}, 5);
...
DescriptionFunctions["current_item_magic_key_ring_artifact_param"] = DescriptionRuntime.memoize(function(ctx) {
  const itemData = DescriptionRuntime.get(ctx.currentItem, "config.bonuses[0].parameters[0]");
  return DescriptionRuntime.formatModInt(itemData);
}, 5);
...
DescriptionFunctions["current_shamaniac_soul_item_set_param_1"] = DescriptionRuntime.memoize(function(ctx) {
  const setData = DescriptionRuntime.get(ctx.currentItemSet, "config.bonuses[0].heroBonuses[0].parameters[1]");
...
DescriptionFunctions["current_knights_honor_item_set_param_2"] = DescriptionRuntime.memoize(function(ctx) {
  const setData = DescriptionRuntime.get(ctx.currentItemSet, "config.bonuses[1].heroBonuses[0].parameters[1]");
  return DescriptionRuntime.formatModPercentNumeric(setData);
}, 5);
...
DescriptionFunctions["current_paupers_glory_item_set_param_3"] = DescriptionRuntime.memoize(function(ctx) {
  const setData = DescriptionRuntime.get(ctx.currentItemSet, "config.bonuses[2].heroBonuses[0].parameters[1]");
  return DescriptionRuntime.formatModInt(setData);
}, 5);
...
DescriptionFunctions["current_skill_assault_param"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[3]");
...
DescriptionFunctions["current_sub_skill_assault_1_param"] = DescriptionRuntime.memoize(function(ctx) {
  const subSkillData = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[1]");
...
DescriptionFunctions["current_sub_skill_assault_2_param"] = DescriptionRuntime.memoize(function(ctx) {
  const subSkillData = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[3]");
...
DescriptionFunctions["current_skill_leadership_param"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[1]");
...
DescriptionFunctions["current_sub_skill_leadership_4_param_2"] = DescriptionRuntime.memoize(function(ctx) {
  const subSkillData = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[3].parameters[1]");
  return DescriptionRuntime.formatModInt(subSkillData);
}, 5);
...
DescriptionFunctions["current_sub_skill_luck_2_param"] = DescriptionRuntime.memoize(function(ctx) {
  const subSkillData = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[2]");
  return DescriptionRuntime.formatModPercentNumeric(subSkillData);
}, 5);
...
DescriptionFunctions["current_sub_skill_economy_2_param"] = DescriptionRuntime.memoize(function(ctx) {
  const subSkillData = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[0]");
  return DescriptionRuntime.formatModInt(subSkillData);
}, 5);
...
DescriptionFunctions["current_skill_magic"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[2]");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_skill_magic_2"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[1].parameters[3]");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_skill_magic_3"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[2].parameters[2]");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_sub_skill_magic_day_2"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[1]");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_sub_skill_magic_day_3"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[3]");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_sub_skill_magic_day_4_1"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[2]");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_skill_battlemage_param"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[1].parameters[1]");
  return DescriptionRuntime.formatModPercentNumeric(skillData);
}, 5);
...
DescriptionFunctions["current_sub_skill_scouting_5_param"] = DescriptionRuntime.memoize(function(ctx) {
  const viewRadius = DescriptionRuntime.get(ctx.currentHero, "heroStat.viewRadius");
  const heroRadius = (Number(viewRadius) || 0) * (Number("2") || 0);
  return DescriptionRuntime.formatModInt(heroRadius);
}, 5);
...
DescriptionFunctions["current_skill_formation_param"] = DescriptionRuntime.memoize(function(ctx) {
  const sideBuff = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[1]");
  const buffData = DescriptionRuntime.get(GameData.sidebuffs?.[sideBuff], "actions[0].damageDealer.buff.sid");
  const skillData = DescriptionRuntime.get(GameData.buffs?.[buffData], "data.stats.offencePerc");
  return DescriptionRuntime.formatModPercentNumeric(skillData);
}, 5);
...
DescriptionFunctions["current_skill_tactics_param"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[1].parameters[1]");
  const skillData2 = (Number(skillData) || 0) + (Number("1") || 0);
...
DescriptionFunctions["current_sub_skill_tactics_2_param"] = DescriptionRuntime.memoize(function(ctx) {
  const sideBuff = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[1]");
  const buffData = DescriptionRuntime.get(GameData.sidebuffs?.[sideBuff], "actions[0].damageDealer.buff.sid");
  const skillData = DescriptionRuntime.get(GameData.buffs?.[buffData], "data.stats.initiative");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_skill_trainer_param_3"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[2].parameters[1]");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_skill_trainer_param_4"] = DescriptionRuntime.memoize(function(ctx) {
  const skillData = DescriptionRuntime.get(ctx.currentSkill, "bonuses[3].parameters[1]");
  return DescriptionRuntime.formatModInt(skillData);
}, 5);
...
DescriptionFunctions["current_skill_warrior_ability_param_1"] = DescriptionRuntime.memoize(function(ctx) {
  const abilitySid = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[0]");
  const abilityLevel = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[1]");
  const minBaseDmg = DescriptionRuntime.get(GameData.abilitys?.[abilitySid], "");
  const maxBaseDmg = DescriptionRuntime.get(GameData.abilitys?.[abilitySid], "");
  const baseDmg = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
...
DescriptionFunctions["current_skill_warrior_ability_param_2"] = DescriptionRuntime.memoize(function(ctx) {
  const abilitySid = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[0]");
  const abilityLevel = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[1]");
  const damageMultiplerPerHeroLevel = DescriptionRuntime.get(GameData.abilitys?.[abilitySid], "");
...
DescriptionFunctions["current_skill_mage_ability_param_2"] = DescriptionRuntime.memoize(function(ctx) {
  const abilitySid = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[0]");
  const abilityLevel = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[1]");
  const minStackDmg = DescriptionRuntime.get(GameData.abilitys?.[abilitySid], "");
...
DescriptionFunctions["current_skill_faction_humans"] = DescriptionRuntime.memoize(function(ctx) {
  const sideBuff = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[1]");
  const buffData = DescriptionRuntime.get(GameData.sidebuffs?.[sideBuff], "actions[0].damageDealer.buff.sid");
  const skillData = DescriptionRuntime.get(GameData.buffs?.[buffData], "data.stats.hpPerc");
  return DescriptionRuntime.formatModPercentNumeric(skillData);
}, 5);
...
DescriptionFunctions["current_sub_skill_faction_humans_2_param"] = DescriptionRuntime.memoize(function(ctx) {
  const sideBuff = DescriptionRuntime.get(ctx.currentSubSkill, "bonuses[0].parameters[1]");
  const buffData = DescriptionRuntime.get(GameData.sidebuffs?.[sideBuff], "actions[0].damageDealer.buff.sid");
  const skillData = DescriptionRuntime.get(GameData.buffs?.[buffData], "data.stats.outAllDmgMod");
  return DescriptionRuntime.formatModPercentNumeric(skillData);
}, 5);
...
DescriptionFunctions["current_skill_faction_demons"] = DescriptionRuntime.memoize(function(ctx) {
  const abilitySid = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[0]");
  const abilityLevel = DescriptionRuntime.get(ctx.currentSkill, "bonuses[0].parameters[1]");
  const summonSid = DescriptionRuntime.get(GameData.abilitys?.[abilitySid], "");
  const summonData = DescriptionRuntime.get(GameData.obstacles?.[summonSid], "onTimeoutMechanic.values[2]");
...
DescriptionFunctions["current_specialization_flat_base_bonus"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[0].parameters[1]");
...
DescriptionFunctions["current_specialization_flat_base_bonus_1"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[1].parameters[1]");
  return DescriptionRuntime.formatModInt(specData);
}, 5);
...
DescriptionFunctions["current_specialization_flat_increment"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[0].upgrade.increment");
  return DescriptionRuntime.formatModInt(specData);
}, 5);
...
DescriptionFunctions["current_specialization_flat_increment_1"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[1].upgrade.increment");
  return DescriptionRuntime.formatModInt(specData);
}, 5);
...
DescriptionFunctions["current_specialization_flat_level_step"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[0].upgrade.levelStep");
  return DescriptionRuntime.formatModInt(specData);
}, 5);
...
DescriptionFunctions["current_specialization_flat_level_step_1"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[1].upgrade.levelStep");
  return DescriptionRuntime.formatModInt(specData);
}, 5);
...
DescriptionFunctions["current_specialization_perc_base_bonus_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[0].parameters[3]");
  return DescriptionRuntime.formatModPercentNumeric(specData);
}, 5);
...
DescriptionFunctions["current_specialization_unit_base_bonus_3"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[3].parameters[1]");
  return DescriptionRuntime.formatModPercentNumeric(specData);
}, 5);
...
DescriptionFunctions["current_specialization_unit_increment"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[4].upgrade.increment");
  return DescriptionRuntime.formatModInt(specData);
}, 5);
...
DescriptionFunctions["current_specialization_unit_level_step"] = DescriptionRuntime.memoize(function(ctx) {
  const specData = DescriptionRuntime.get(ctx.currentSpecialization, "bonuses[4].upgrade.levelStep");
  return DescriptionRuntime.formatModInt(specData);
}, 5);
...
DescriptionFunctions["current_specialization_dungeon_hero_3_spec_bonus_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const damageBase = DescriptionRuntime.get(GameData.buffs?.["skill_dungeon_hero_3_debuff"], "actions[0].damageDealer.minBaseDmg");
  const damageMultiplerPerHeroLevel = DescriptionRuntime.get(GameData.buffs?.["skill_dungeon_hero_3_debuff"], "actions[0].damageDealer.damageMultiplerPerHeroLevel");
  const heroLevelBase = DescriptionRuntime.get(ctx.currentHero, "level");
  const heroLevel = (Number(heroLevelBase) || 0) - (Number("1") || 0);
  const damageMultipler = (Number(damageMultiplerPerHeroLevel) || 0) * (Number(heroLevel) || 0);
  const damageBonus = (Number(damageBase) || 0) * (Number(damageMultipler) || 0);
  const damage = (Number(damageBase) || 0) + (Number(damageBonus) || 0);
...
DescriptionFunctions["alt_text_dot_damage_amount_level_base"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(GameData.buffs?.["skill_dungeon_hero_3_debuff"], "actions[0].damageDealer.minBaseDmg");
}, 5);
...
DescriptionFunctions["alt_text_dot_damage_amount_level_bonus"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(GameData.buffs?.["skill_dungeon_hero_3_debuff"], "actions[0].damageDealer.damageMultiplerPerHeroLevel");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_mana_cost"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "manaCost[0]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_mana_cost"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "manaCost[1]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_mana_cost"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "manaCost[2]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_mana_cost"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "manaCost[3]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_1_param_mana_cost"] = DescriptionRuntime.memoize(function(ctx) {
  const manaCostBase = DescriptionRuntime.get(ctx.currentMagic, "manaCost[0]");
  const manaCostNext = DescriptionRuntime.get(ctx.currentMagic, "manaCost[1]");
  const return = (Number(manaCostBase) || 0) - (Number(manaCostNext) || 0);
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_2_param_mana_cost"] = DescriptionRuntime.memoize(function(ctx) {
  const manaCostBase = DescriptionRuntime.get(ctx.currentMagic, "manaCost[1]");
  const manaCostNext = DescriptionRuntime.get(ctx.currentMagic, "manaCost[2]");
  const return = (Number(manaCostBase) || 0) - (Number(manaCostNext) || 0);
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_3_param_mana_cost"] = DescriptionRuntime.memoize(function(ctx) {
  const manaCostBase = DescriptionRuntime.get(ctx.currentMagic, "manaCost[2]");
  const manaCostNext = DescriptionRuntime.get(ctx.currentMagic, "manaCost[3]");
  const return = (Number(manaCostBase) || 0) - (Number(manaCostNext) || 0);
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_damage_base"] = DescriptionRuntime.memoize(function(ctx) {
  const minBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].maxBaseDmg");
  const return = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_damage_base"] = DescriptionRuntime.memoize(function(ctx) {
  const minBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].maxBaseDmg");
  const return = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_damage_base"] = DescriptionRuntime.memoize(function(ctx) {
  const minBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].maxBaseDmg");
  const return = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_damage_base"] = DescriptionRuntime.memoize(function(ctx) {
  const minBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].maxBaseDmg");
  const return = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_damage_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const minStackDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].maxStackDmg");
  const return = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_damage_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const minStackDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].maxStackDmg");
  const return = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_damage_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const minStackDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].maxStackDmg");
  const return = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_damage_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const minStackDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].maxStackDmg");
  const return = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_damage_percent_base"] = DescriptionRuntime.memoize(function(ctx) {
  const minPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].minPercentDmg");
  const maxPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].maxPercentDmg");
  const return = ((Number(minPercentDmg) || 0) + (Number(maxPercentDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_damage_percent_base"] = DescriptionRuntime.memoize(function(ctx) {
  const minPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].minPercentDmg");
  const maxPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].maxPercentDmg");
  const return = ((Number(minPercentDmg) || 0) + (Number(maxPercentDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_damage_percent_base"] = DescriptionRuntime.memoize(function(ctx) {
  const minPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].minPercentDmg");
  const maxPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].maxPercentDmg");
  const return = ((Number(minPercentDmg) || 0) + (Number(maxPercentDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_damage_percent_base"] = DescriptionRuntime.memoize(function(ctx) {
  const minPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].minPercentDmg");
  const maxPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].maxPercentDmg");
  const return = ((Number(minPercentDmg) || 0) + (Number(maxPercentDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_damage_percent_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const minStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].minStackPercentDmg");
  const maxStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].maxStackPercentDmg");
  const return = ((Number(minStackPercentDmg) || 0) + (Number(maxStackPercentDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_damage_percent_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const minStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].minStackPercentDmg");
  const maxStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].maxStackPercentDmg");
  const return = ((Number(minStackPercentDmg) || 0) + (Number(maxStackPercentDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_damage_percent_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const minStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].minStackPercentDmg");
  const maxStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].maxStackPercentDmg");
  const return = ((Number(minStackPercentDmg) || 0) + (Number(maxStackPercentDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_damage_percent_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const minStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].minStackPercentDmg");
  const maxStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].maxStackPercentDmg");
  const return = ((Number(minStackPercentDmg) || 0) + (Number(maxStackPercentDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_heal_base"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].targetMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_heal_base"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].targetMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_heal_base"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].targetMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_heal_base"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].targetMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_heal_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].targetMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_heal_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].targetMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_heal_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].targetMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_heal_per_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].targetMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.duration");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].buff.duration");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].buff.duration");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].buff.duration");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_0_param_temp_stack_perCount"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].targetMechanics[0].values[3]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_1_param_temp_stack_perCount"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].targetMechanics[0].values[3]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_2_param_temp_stack_perCount"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].targetMechanics[0].values[3]");
}, 5);
...
DescriptionFunctions["current_magic_upgrade_3_param_temp_stack_perCount"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].targetMechanics[0].values[3]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_offence"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.offence");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_buff_offence"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.offence");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_buff_offence"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.offence");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_buff_offence"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.offence");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_defence"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.defence");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_speed"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.speed");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_initiative"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.initiative");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_moral"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.moral");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_luck"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.luck");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_skipActionChanceModifier"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.skipActionChanceModifier");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_anticritChanceModifier"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.anticritChanceModifier");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_outAllDmgMod"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.outAllDmgMod");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_inAllDmgMod"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.inAllDmgMod");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_outAllDmgMod_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].targetMechanics[0].values[0]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.outAllDmgMod");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_buff_outAllDmgMod_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].targetMechanics[0].values[0]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.outAllDmgMod");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_buff_outAllDmgMod_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].targetMechanics[0].values[0]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.outAllDmgMod");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_buff_outAllDmgMod_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].targetMechanics[0].values[0]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.outAllDmgMod");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_hpPerc"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.hpPerc");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_finalHealingBonusPercent"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.finalHealingBonusPercent");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_healthLimitMinPercent"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.healthLimitMinPercent");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_outDmgMods"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.outDmgMods.list[0].v");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_inDmgMods"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.inDmgMods.list[0].v");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_numCounters"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.numCounters");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_tauntRadius"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.tauntRadius");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_buff_actionsDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.targetMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_summonRange"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].castTargetParams.distance");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_summonRange"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].castTargetParams.distance");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_summonRange"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].castTargetParams.distance");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_summonRange"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].castTargetParams.distance");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_summonSP"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].targetMechanics[0].values[4]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_summonSP"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].targetMechanics[0].values[4]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_summonSP"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].targetMechanics[0].values[4]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_summonSP"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].targetMechanics[0].values[4]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_minDamagePerEnergyLevel"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].minDamagePerEnergyLevel");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_minDamagePerEnergyLevel"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].minDamagePerEnergyLevel");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_minDamagePerEnergyLevel"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].minDamagePerEnergyLevel");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_minDamagePerEnergyLevel"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].minDamagePerEnergyLevel");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_levelDmg"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].levelDmg");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_levelDmg"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].levelDmg");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_levelDmg"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].levelDmg");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_levelDmg"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].levelDmg");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_numTargets"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].numTargets");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_numTargets"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].numTargets");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_numTargets"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].numTargets");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_numTargets"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].numTargets");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_blink_range"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].orderedCastParams[0].distanceFromFirst");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_blink_range"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[1].orderedCastParams[0].distanceFromFirst");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_blink_range"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[2].orderedCastParams[0].distanceFromFirst");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_blink_range"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[3].orderedCastParams[0].distanceFromFirst");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_add_move_points"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[0].parameters[0]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_add_move_points"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[1].parameters[0]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_add_move_points"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[2].parameters[0]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_add_move_points"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[3].parameters[0]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_farsight_range"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[0].parameters[2]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_farsight_range"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[1].parameters[2]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_farsight_range"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[2].parameters[2]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_farsight_range"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[3].parameters[2]");
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_0_param_primordial_chaos_power"] = DescriptionRuntime.memoize(function(ctx) {
  const data = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[0].parameters[1]");
  const return = (Number("1") || 0) - (Number(data) || 0);
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_1_param_primordial_chaos_power"] = DescriptionRuntime.memoize(function(ctx) {
  const data = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[1].parameters[1]");
  const return = (Number("1") || 0) - (Number(data) || 0);
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_2_param_primordial_chaos_power"] = DescriptionRuntime.memoize(function(ctx) {
  const data = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[2].parameters[1]");
  const return = (Number("1") || 0) - (Number(data) || 0);
}, 5);
...
DescriptionFunctions["current_magic_unpgrade_3_param_primordial_chaos_power"] = DescriptionRuntime.memoize(function(ctx) {
  const data = DescriptionRuntime.get(ctx.currentMagic, "worldMagic.magicSettings[3].parameters[1]");
  const return = (Number("1") || 0) - (Number(data) || 0);
}, 5);
...
DescriptionFunctions["current_magic_buff_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const baseDuration = DescriptionRuntime.get(ctx.currentMagic, "buff.duration");
  const spCount = DescriptionRuntime.get(ctx.currentMagic, "buff.durationPerStack[0]");
  const spBonusDuration = DescriptionRuntime.get(ctx.currentMagic, "buff.durationPerStack[1]");
  const spBonusDurationMul = (Number(count) || 0) * (Number(spBonusDuration) || 0);
  const spBonusDurationMulDiv = (Number(spBonusDurationMul) || 0) / (Number(spCount) || 0);
  const spBonusDurationMulDivFloor = Math.floor(Number(spBonusDurationMulDiv) || 0);
  const fullDuration = (Number(baseDuration) || 0) + (Number(spBonusDurationMulDivFloor) || 0);
...
DescriptionFunctions["current_magic_trap_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const baseDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
  const spCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
  const spBonusDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[4]");
  const spBonusDurationMul = (Number(count) || 0) * (Number(spBonusDuration) || 0);
  const spBonusDurationMulDiv = (Number(spBonusDurationMul) || 0) / (Number(spCount) || 0);
  const spBonusDurationMulDivFloor = Math.floor(Number(spBonusDurationMulDiv) || 0);
  const fullDuration = (Number(baseDuration) || 0) + (Number(spBonusDurationMulDivFloor) || 0);
...
DescriptionFunctions["current_magic_object_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const summonSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const summonData = DescriptionRuntime.get(GameData.obstacles?.[summonSid], "lifetime");
...
DescriptionFunctions["current_magic_numTargets"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "numTargets");
}, 5);
...
DescriptionFunctions["current_magic_damage_common"] = DescriptionRuntime.memoize(function(ctx) {
  const minBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentMagic, "maxBaseDmg");
  const minStackDmg = DescriptionRuntime.get(ctx.currentMagic, "minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(ctx.currentMagic, "maxStackDmg");
  const baseDmg = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const dmgCount = (Number(count) || 0) * (Number(stackDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(dmgCount) || 0);
...
DescriptionFunctions["current_magic_damage_max_unit_percent"] = DescriptionRuntime.memoize(function(ctx) {
  const minPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "minPercentDmg");
  const maxPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "maxPercentDmg");
  const minStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "minStackPercentDmg");
  const maxStackPercentDmg = DescriptionRuntime.get(ctx.currentMagic, "maxStackPercentDmg");
  const baseDmg = ((Number(minPercentDmg) || 0) + (Number(maxPercentDmg) || 0)) / 2;
  const stackDmg = ((Number(minStackPercentDmg) || 0) + (Number(maxStackPercentDmg) || 0)) / 2;
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const dmgCount = (Number(count) || 0) * (Number(stackDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(dmgCount) || 0);
...
DescriptionFunctions["current_magic_summon"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const baseSummon = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
  const spCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
  const spBonusSummon = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[4]");
  const fullStacksMul = (Number(count) || 0) * (Number(spBonusSummon) || 0);
  const fullStacksDiv = (Number(fullStacksMul) || 0) / (Number(spCount) || 0);
  const fullStacksDivFloor = Math.floor(Number(fullStacksDiv) || 0);
  const fullStacksSummon = (Number(baseSummon) || 0) + (Number(fullStacksDivFloor) || 0);
...
DescriptionFunctions["current_magic_baseHeal"] = DescriptionRuntime.memoize(function(ctx) {
  const baseHeal = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[0]");
...
DescriptionFunctions["current_magic_healPerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const healPerCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
...
DescriptionFunctions["current_magic_baseHeal_percent"] = DescriptionRuntime.memoize(function(ctx) {
  const baseHeal = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
...
DescriptionFunctions["current_magic_healPerCount_percent"] = DescriptionRuntime.memoize(function(ctx) {
  const healPerCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
...
DescriptionFunctions["current_magic_baseBuffDuration"] = DescriptionRuntime.memoize(function(ctx) {
  const baseBuffDuration = DescriptionRuntime.get(ctx.currentMagic, "buff.duration");
...
DescriptionFunctions["current_magic_durationBuffPerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const bonusBuffDuration = DescriptionRuntime.get(ctx.currentMagic, "buff.durationPerStack[1]");
...
DescriptionFunctions["current_magic_countBuffDuration"] = DescriptionRuntime.memoize(function(ctx) {
  const countBuffDuration = DescriptionRuntime.get(ctx.currentMagic, "buff.durationPerStack[0]");
...
DescriptionFunctions["current_magic_addBuffDuration_base"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
...
DescriptionFunctions["current_magic_addBuffDuration_stackDuration"] = DescriptionRuntime.memoize(function(ctx) {
  const stackDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
...
DescriptionFunctions["current_magic_addBuffDuration_perStack"] = DescriptionRuntime.memoize(function(ctx) {
  const perStack = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
...
DescriptionFunctions["current_magic_addBuffDuration_base_2"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[1].values[1]");
  return DescriptionRuntime.formatModInt(baseDuration);
}, 5);
...
DescriptionFunctions["current_magic_addBuffDuration_stackDuration_2"] = DescriptionRuntime.memoize(function(ctx) {
  const stackDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[1].values[2]");
  return DescriptionRuntime.formatModInt(stackDuration);
}, 5);
...
DescriptionFunctions["current_magic_addBuffDuration_perStack_2"] = DescriptionRuntime.memoize(function(ctx) {
  const perStack = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[1].values[3]");
  return DescriptionRuntime.formatModInt(perStack);
}, 5);
...
DescriptionFunctions["current_magic_baseDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDamage = DescriptionRuntime.get(ctx.currentMagic, "minBaseDmg");
...
DescriptionFunctions["current_magic_damagePerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const damagePerCount = DescriptionRuntime.get(ctx.currentMagic, "minStackDmg");
...
DescriptionFunctions["current_magic_baseTrapDuration"] = DescriptionRuntime.memoize(function(ctx) {
  const baseTrapDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
...
DescriptionFunctions["current_magic_durationTrapPerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const durationTrapPerCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[4]");
...
DescriptionFunctions["current_magic_countTrapDuration"] = DescriptionRuntime.memoize(function(ctx) {
  const countTrapDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
...
DescriptionFunctions["current_magic_sightRadiusMultipler0"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "parameters[0]");
}, 5);
...
DescriptionFunctions["current_magic_sightRadiusMultipler1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "parameters[1]");
}, 5);
...
DescriptionFunctions["current_magic_sightRadiusMultipler2"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "parameters[2]");
}, 5);
...
DescriptionFunctions["current_magic_sightRadiusMultipler3"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "parameters[3]");
}, 5);
...
DescriptionFunctions["alt_text_damage_amount_earths_rage_1_1"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDamage = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[0]");
  return DescriptionRuntime.formatInt(baseDamage);
}, 5);
...
DescriptionFunctions["alt_text_damage_amount_earths_rage_1_2"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDamage = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  return DescriptionRuntime.formatInt(baseDamage);
}, 5);
...
DescriptionFunctions["alt_text_damage_amount_earths_rage_2_1"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDamage = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
  return DescriptionRuntime.formatInt(baseDamage);
}, 5);
...
DescriptionFunctions["current_magic_baseTrapDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const summonSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const baseTrapDamage = DescriptionRuntime.get(GameData.traps?.[summonSid], "damageDealer.minBaseDmg");
...
DescriptionFunctions["current_magic_countTrapDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const summonSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const countTrapDamage = DescriptionRuntime.get(GameData.traps?.[summonSid], "damageDealer.minStackDmg");
...
DescriptionFunctions["current_magic_baseCopyDuration"] = DescriptionRuntime.memoize(function(ctx) {
  const baseCopyDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
...
DescriptionFunctions["current_magic_durationCopyPerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const durationCopyPerCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
...
DescriptionFunctions["current_magic_countCopyDuration"] = DescriptionRuntime.memoize(function(ctx) {
  const countCopyDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
...
DescriptionFunctions["current_magic_basePercentDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const basePercentDamage = DescriptionRuntime.get(ctx.currentMagic, "minPercentDmg");
...
DescriptionFunctions["current_magic_percentDamagePerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const percentDamagePerCount = DescriptionRuntime.get(ctx.currentMagic, "minStackPercentDmg");
...
DescriptionFunctions["current_magic_baseDotDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.minBaseDmg");
}, 5);
...
DescriptionFunctions["current_magic_baseDotDamagePerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.minStackDmg");
}, 5);
...
DescriptionFunctions["current_magic_baseRevengeDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.targetMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["current_magic_baseRevengeDamagePerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.targetMechanics[0].values[3]");
}, 5);
...
DescriptionFunctions["current_magic_summonPerCount"] = DescriptionRuntime.memoize(function(ctx) {
  const summonPerCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[4]");
...
DescriptionFunctions["current_magic_baseBuffDuration_doreaths_tide"] = DescriptionRuntime.memoize(function(ctx) {
  const baseBuffDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
  return DescriptionRuntime.formatInt(baseBuffDuration);
}, 5);
...
DescriptionFunctions["current_magic_durationBuffPerCount_doreaths_tide"] = DescriptionRuntime.memoize(function(ctx) {
  const bonusBuffDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
  return DescriptionRuntime.formatInt(bonusBuffDuration);
}, 5);
...
DescriptionFunctions["current_magic_countBuffDuration_doreaths_tide"] = DescriptionRuntime.memoize(function(ctx) {
  const countBuffDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[4]");
  return DescriptionRuntime.formatInt(countBuffDuration);
}, 5);
...
DescriptionFunctions["alt_text_summon_hp"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[5]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.hp");
}, 5);
...
DescriptionFunctions["alt_text_summon_dmg"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[5]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.damageMin");
}, 5);
...
DescriptionFunctions["current_day_1_magic_healing_water"] = DescriptionRuntime.memoize(function(ctx) {
  const baseHeal = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[0]");
  const perCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const healPerCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const healCount = (Number(count) || 0) * (Number(healPerCount) || 0);
  const healCountPerCount = (Number(healCount) || 0) / (Number(perCount) || 0);
  const fhealCountPerCountFloor = Math.floor(Number(healCountPerCount) || 0);
  const heal = (Number(baseHeal) || 0) + (Number(fhealCountPerCountFloor) || 0);
...
DescriptionFunctions["current_day_1_magic_healing_water_1"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const perStack = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[1].values[3]");
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const perSpBonus = (Number(count) || 0) / (Number(perStack) || 0);
  const spDuration = (Number(stackDuration) || 0) * (Number(perSpBonus) || 0);
  const duration = (Number(baseDuration) || 0) + (Number(spDuration) || 0);
...
DescriptionFunctions["current_day_7_magic_inner_light_old"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.energyPerCast");
}, 5);
...
DescriptionFunctions["current_day_13_vengeance"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const baseDamage = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.targetMechanics[0].values[2]");
  const stackBonus = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.targetMechanics[0].values[3]");
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const stackDamage = (Number(stackBonus) || 0) * (Number(count) || 0);
  const return = (Number(baseDamage) || 0) + (Number(stackDamage) || 0);
}, 5);
...
DescriptionFunctions["current_night_4_magic_despair"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const buffData = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.minStackDmg");
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const return = (Number(count) || 0) * (Number(buffData) || 0);
}, 5);
...
DescriptionFunctions["current_night_16_magic_shadow_army"] = DescriptionRuntime.memoize(function(ctx) {
  const baseHeal = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
  const healPerStack = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const mul = (Number(count) || 0) * (Number(healPerStack) || 0);
  const return = (Number(baseHeal) || 0) + (Number(mul) || 0);
}, 5);
...
DescriptionFunctions["current_night_16_magic_shadow_army_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[5]");
}, 5);
...
DescriptionFunctions["current_night_14_magic_nairas_kiss_new"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const minBaseDmg = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.maxBaseDmg");
  const minStackDmg = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.maxStackDmg");
  const baseDmg = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const mul = (Number(count) || 0) * (Number(stackDmg) || 0);
  const return = (Number(baseDmg) || 0) + (Number(mul) || 0);
}, 5);
...
DescriptionFunctions["current_night_14_magic_nairas_kiss_new_buff_damage"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSP = ctx.currentBuff.getSpellPower?.() ?? 0;
  const baseDamage = DescriptionRuntime.get(ctx.currentBuff, "config.actions[0].damageDealer.minBaseDmg");
  const stackBonus = DescriptionRuntime.get(ctx.currentBuff, "config.actions[0].damageDealer.minStackDmg");
  const stackDamage = (Number(stackBonus) || 0) * (Number(buffSP) || 0);
  const return = (Number(baseDamage) || 0) + (Number(stackDamage) || 0);
}, 5);
...
DescriptionFunctions["current_buff_magic_deaths_call_effect"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.actions[0].damageDealer.targetMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["current_bonus_magic_astral_summon_hp"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[5]");
  const hp = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.hp");
  const mul = (Number(count) || 0) * (Number(hp) || 0);
  const return = (Number(mul) || 0) + (Number("50") || 0);
}, 5);
...
DescriptionFunctions["current_bonus_magic_astral_summon_damage"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[5]");
  const damage = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.damageMin");
  const mul = (Number(count) || 0) * (Number(damage) || 0);
  const return = (Number(mul) || 0) + (Number("5") || 0);
}, 5);
...
DescriptionFunctions["current_primal_5_magic_crystal_crown"] = DescriptionRuntime.memoize(function(ctx) {
  const summonSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const summonData = DescriptionRuntime.get(GameData.obstacles?.[summonSid], "stats.hp");
...
DescriptionFunctions["current_primal_7_magic_wall_of_flame"] = DescriptionRuntime.memoize(function(ctx) {
  const summonSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const minBaseDmg = DescriptionRuntime.get(GameData.traps?.[summonSid], "damageDealer.minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(GameData.traps?.[summonSid], "damageDealer.maxBaseDmg");
  const minStackDmg = DescriptionRuntime.get(GameData.traps?.[summonSid], "damageDealer.minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(GameData.traps?.[summonSid], "damageDealer.maxStackDmg");
  const baseDmg = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const dmgCount = (Number(count) || 0) * (Number(stackDmg) || 0);
...
DescriptionFunctions["current_primal_7_magic_wall_of_flame_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["current_primal_9_magic_earths_rage_damage_buildings"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const baseDmg = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[0]");
  const stackDmg = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const damageCount = (Number(count) || 0) * (Number(stackDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(damageCount) || 0);
  return DescriptionRuntime.formatModInt(damage);
}, 5);
...
DescriptionFunctions["current_primal_9_magic_earths_rage_damage_units"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const baseDmg = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
  const stackDmg = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
  const damageCount = (Number(count) || 0) * (Number(stackDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(damageCount) || 0);
  return DescriptionRuntime.formatModInt(damage);
}, 5);
...
DescriptionFunctions["current_primal_10_magic_primordial_purity"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.immunities[0].tags[0]");
}, 5);
...
DescriptionFunctions["current_primal_10_magic_primordial_purity_effect"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.immunities[0].tags[0]");
}, 5);
...
DescriptionFunctions["current_space_2_magic_energy_explosion"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "minDamagePerEnergyLevel");
}, 5);
...
DescriptionFunctions["current_space_9_magic_impending_fate"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "levelDmg");
}, 5);
...
DescriptionFunctions["current_space_5_magic_trap_jaws"] = DescriptionRuntime.memoize(function(ctx) {
  const summonSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const summonData = DescriptionRuntime.get(GameData.traps?.[summonSid], "damageDealer.minPercentDmg");
  return DescriptionRuntime.formatModPercentNumeric(summonData);
}, 5);
...
DescriptionFunctions["current_space_6_magic_blink"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "orderedCastParams[0].distanceFromFirst");
}, 5);
...
DescriptionFunctions["current_space_10_magic_mirror_copy_1"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[0]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.outAllDmgMod");
}, 5);
...
DescriptionFunctions["current_space_10_magic_mirror_copy_duration"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const baseDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const spCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
  const spBonusDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[2]");
  const spBonusDurationMul = (Number(count) || 0) * (Number(spBonusDuration) || 0);
  const spBonusDurationMulDiv = (Number(spBonusDurationMul) || 0) / (Number(spCount) || 0);
  const spBonusDurationMulDivFloor = Math.floor(Number(spBonusDurationMulDiv) || 0);
  const fullDuration = (Number(baseDuration) || 0) + (Number(spBonusDurationMulDivFloor) || 0);
...
DescriptionFunctions["current_space_16_magic_reality_distortion_0_param_damage"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "battleMagic.magicDealers[0].buff.sid");
  const buffData = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.targetMechanics[0].values[0]");
  const return = (Number("1.01") || 0) - (Number(buffData) || 0);
}, 5);
...
DescriptionFunctions["current_space_14_magic_doreaths_tide"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[1]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.speed");
}, 5);
...
DescriptionFunctions["current_space_14_magic_doreaths_tide_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const count = ctx.currentHero?.getSpellPower?.(ctx.currentMagic?.school) ?? 0;
  const baseDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[3]");
  const spCount = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[4]");
  const spBonusDuration = DescriptionRuntime.get(ctx.currentMagic, "targetMechanics[0].values[5]");
  const spBonusDurationMul = (Number(count) || 0) * (Number(spBonusDuration) || 0);
  const spBonusDurationMulDiv = (Number(spBonusDurationMul) || 0) / (Number(spCount) || 0);
  const spBonusDurationMulDivFloor = Math.floor(Number(spBonusDurationMulDiv) || 0);
  const fullDuration = (Number(baseDuration) || 0) + (Number(spBonusDurationMulDivFloor) || 0);
...
DescriptionFunctions["current_day_18_magic_farsight_1"] = DescriptionRuntime.memoize(function(ctx) {
  const baseRadius = DescriptionRuntime.get(ctx.currentMagic, "parameters[0]");
  const bonusRadius = DescriptionRuntime.get(ctx.currentMagic, "parameters[1]");
  const levelSub = (Number(level) || 0) - (Number(1) || 0);
  const bonusRadiusMul = (Number(bonusRadius) || 0) * (Number(levelSub) || 0);
  const finalRadius = (Number(baseRadius) || 0) + (Number(bonusRadiusMul) || 0);
...
DescriptionFunctions["current_day_18_magic_farsight_2"] = DescriptionRuntime.memoize(function(ctx) {
  const baseRadius = DescriptionRuntime.get(ctx.currentMagic, "parameters[2]");
  const viewRadius = DescriptionRuntime.get(ctx.currentHero, "heroStat.viewRadius");
  const heroRadius = (Number(viewRadius) || 0) * (Number(baseRadius) || 0);
  return DescriptionRuntime.formatModInt(heroRadius);
}, 5);
...
DescriptionFunctions["current_day_18_magic_farsight_3"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentMagic, "usageLimit");
}, 5);
...
DescriptionFunctions["current_neutral_magic_second_sight_1"] = DescriptionRuntime.memoize(function(ctx) {
  const baseMove = DescriptionRuntime.get(ctx.currentMagic, "parameters[0]");
  const bonusMove = DescriptionRuntime.get(ctx.currentMagic, "parameters[1]");
  const levelSub = (Number(level) || 0) - (Number(1) || 0);
  const bonusMoveMul = (Number(bonusMove) || 0) * (Number(levelSub) || 0);
  const finalMove = (Number(baseMove) || 0) + (Number(bonusMoveMul) || 0);
...
DescriptionFunctions["current_neutral_magic_shadow_form"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentMagic, "parameters[0]");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.inAllDmgMod");
}, 5);
...
DescriptionFunctions["current_primal_18_magic_primordial_chaos_2"] = DescriptionRuntime.memoize(function(ctx) {
  const data = DescriptionRuntime.get(ctx.currentMagic, "parameters[1]");
  const return = (Number("1") || 0) - (Number(data) || 0);
}, 5);
...
DescriptionFunctions["current_unit_ability_buff_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const fullStacks = DescriptionRuntime.get(ctx.currentUnit, "fullStacks");
  const startStacks = DescriptionRuntime.get(ctx.currentUnit, "startBattleFullStacks");
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseDuration = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.buff.duration");
  const unitsCount = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.buff.durationPerStack[0]");
  const unitsBonusDuration = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.buff.durationPerStack[1]");
  const fullStacksMul = (Number(currentStacks) || 0) * (Number(unitsBonusDuration) || 0);
  const fullStacksDiv = (Number(fullStacksMul) || 0) / (Number(unitsCount) || 0);
  const fullStacksDivFloor = Math.floor(Number(fullStacksDiv) || 0);
  const fullStacksAdd = (Number(baseDuration) || 0) + (Number(fullStacksDivFloor) || 0);
...
DescriptionFunctions["current_unit_passive_buff_duration"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseDuration = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.buff.duration");
  const unitsCount = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.buff.durationPerStack[0]");
  const unitsBonusDuration = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.buff.durationPerStack[1]");
  const fullStacksMul = (Number(currentStacks) || 0) * (Number(unitsBonusDuration) || 0);
  const fullStacksDiv = (Number(fullStacksMul) || 0) / (Number(unitsCount) || 0);
  const fullStacksDivFloor = Math.floor(Number(fullStacksDiv) || 0);
  const fullStacksAdd = (Number(baseDuration) || 0) + (Number(fullStacksDivFloor) || 0);
...
DescriptionFunctions["current_unit_ability_min_stat_damage"] = DescriptionRuntime.memoize(function(ctx) {
  const fullStacks = DescriptionRuntime.get(ctx.currentUnit, "fullStacks");
  const startStacks = DescriptionRuntime.get(ctx.currentUnit, "startBattleFullStacks");
  const damageMin = DescriptionRuntime.get(ctx.currentUnit, "damageMin");
  const damageMax = DescriptionRuntime.get(ctx.currentUnit, "damageMax");
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const statDmgMult = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.statDmgMult");
  const damageMult = (Number(statDmgMult) || 0) * (Number(damageMin) || 0);
  const damage = (Number(currentStacks) || 0) * (Number(damageMult) || 0);
  return DescriptionRuntime.formatInt(damage);
}, 5);
...
DescriptionFunctions["current_unit_ability_max_stat_damage"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const statDmgMult = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.statDmgMult");
  const damageMult = (Number(statDmgMult) || 0) * (Number(damageMax) || 0);
  const damage = (Number(currentStacks) || 0) * (Number(damageMult) || 0);
  return DescriptionRuntime.formatInt(damage);
}, 5);
...
DescriptionFunctions["current_unit_ability_avg_stat_damage"] = DescriptionRuntime.memoize(function(ctx) {
  const minDmg = DescriptionFunctions["current_unit_ability_min_stat_damage"]?.(ctx) ?? null;
  const maxDmg = DescriptionFunctions["current_unit_ability_max_stat_damage"]?.(ctx) ?? null;
  return DescriptionRuntime.formatInt("1");
}, 5);
...
DescriptionFunctions["current_unit_ability_common_self_heal"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseHeal = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[0]");
  const unitsCount = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[1]");
  const unitsBonusHeal = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[2]");
  const fullStacksMul = (Number(currentStacks) || 0) * (Number(unitsBonusHeal) || 0);
  const fullStacksDiv = (Number(fullStacksMul) || 0) / (Number(unitsCount) || 0);
  const fullStacksDivFloor = Math.floor(Number(fullStacksDiv) || 0);
  const fullStacksHeal = (Number(baseHeal) || 0) + (Number(fullStacksDivFloor) || 0);
...
DescriptionFunctions["current_unit_ability_common_heal"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseHeal = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[0]");
  const unitsCount = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[1]");
  const unitsBonusHeal = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[2]");
  const fullStacksMul = (Number(currentStacks) || 0) * (Number(unitsBonusHeal) || 0);
  const fullStacksDiv = (Number(fullStacksMul) || 0) / (Number(unitsCount) || 0);
  const fullStacksDivFloor = Math.floor(Number(fullStacksDiv) || 0);
  const fullStacksHeal = (Number(baseHeal) || 0) + (Number(fullStacksDivFloor) || 0);
...
DescriptionFunctions["current_unit_ability_percent_self_heal"] = DescriptionRuntime.memoize(function(ctx) {
  const fullStacks = DescriptionRuntime.get(ctx.currentUnit, "fullStacks");
  const startStacks = DescriptionRuntime.get(ctx.currentUnit, "startBattleFullStacks");
  const hp = DescriptionRuntime.get(ctx.currentUnit, "unit.stats.hp");
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseHeal = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[2]");
  const healMul = (Number(hp) || 0) * (Number(baseHeal) || 0);
...
DescriptionFunctions["current_unit_ability_damage"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const statDmgMult = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.statDmgMult");
  const minBaseDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.maxBaseDmg");
  const minStackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.maxStackDmg");
  const baseDmg = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const stackDmgMul = (Number(currentStacks) || 0) * (Number(stackDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(stackDmgMul) || 0);
  return DescriptionRuntime.formatInt(damage);
}, 5);
...
DescriptionFunctions["current_unit_ability_damage_per_buff"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const minBuffNumDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.minBuffNumDmg");
  const maxBuffNumDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.maxBuffNumDmg");
  const minBuffNumStackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.minBuffNumStackDmg");
  const maxBuffNumStackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.maxBuffNumStackDmg");
  const minDebuffNumDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.minDebuffNumDmg");
  const maxDebuffNumDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.maxDebuffNumDmg");
  const minDebuffNumStackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.minDebuffNumStackDmg");
  const maxDebuffNumStackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.maxDebuffNumStackDmg");
  const buffNumDmg = ((Number(minBuffNumDmg) || 0) + (Number(maxBuffNumDmg) || 0)) / 2;
  const buffNumStackDmg = ((Number(minBuffNumStackDmg) || 0) + (Number(maxBuffNumStackDmg) || 0)) / 2;
  const debuffNumDmg = ((Number(minDebuffNumDmg) || 0) + (Number(maxDebuffNumDmg) || 0)) / 2;
  const debuffNumStackDmg = ((Number(minDebuffNumStackDmg) || 0) + (Number(maxDebuffNumStackDmg) || 0)) / 2;
  const buffNumStackDmgMul = (Number(currentStacks) || 0) * (Number(buffNumStackDmg) || 0);
  const debuffNumStackDmgMul = (Number(currentStacks) || 0) * (Number(debuffNumStackDmg) || 0);
  const fullBuffNumDmg = (Number(buffNumDmg) || 0) + (Number(buffNumStackDmgMul) || 0);
  const fullDebuffNumDmg = (Number(debuffNumDmg) || 0) + (Number(debuffNumStackDmg) || 0);
  const damage = (Number(fullBuffNumDmg) || 0) + (Number(fullDebuffNumDmg) || 0);
  return DescriptionRuntime.formatInt(damage);
}, 5);
...
DescriptionFunctions["current_unit_ability_summon_count"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseSummon = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[2]");
  const unitsCount = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[3]");
  const unitsBonusSummon = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[4]");
  const fullStacksMul = (Number(currentStacks) || 0) * (Number(unitsBonusSummon) || 0);
  const fullStacksDiv = (Number(fullStacksMul) || 0) / (Number(unitsCount) || 0);
  const fullStacksDivFloor = Math.floor(Number(fullStacksDiv) || 0);
  const fullStacksSummon = (Number(baseSummon) || 0) + (Number(fullStacksDivFloor) || 0);
  return DescriptionRuntime.formatInt(fullStacksSummon);
...
DescriptionFunctions["current_unit_ability_trap_duration"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseDuration = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[2]");
  const spCount = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[3]");
  const spBonusDuration = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[4]");
  const spBonusDurationMul = (Number(currentStacks) || 0) * (Number(spBonusDuration) || 0);
  const spBonusDurationMulDiv = (Number(spBonusDurationMul) || 0) / (Number(spCount) || 0);
  const spBonusDurationMulDivFloor = Math.floor(Number(spBonusDurationMulDiv) || 0);
  const fullDuration = (Number(baseDuration) || 0) + (Number(spBonusDurationMulDivFloor) || 0);
  return DescriptionRuntime.formatInt(fullDuration);
...
DescriptionFunctions["current_unit_ability_buff_revenge_damage_param"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const buffSid = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.buff.sid");
  const baseDamage = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.targetMechanics[0].values[2]");
  const stackBonus = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.targetMechanics[0].values[3]");
  const stackDamage = (Number(stackBonus) || 0) * (Number(currentStacks) || 0);
  const return = (Number(baseDamage) || 0) + (Number(stackDamage) || 0);
}, 5);
...
DescriptionFunctions["current_ability_selfMechanics_values_0"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["current_unit_damagePerHex"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "damagePerHex");
}, 5);
...
DescriptionFunctions["current_unit_anticrit"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "anticrit");
}, 5);
...
DescriptionFunctions["current_unit_globalPassives_morale"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "globalPassives[0].data.stats.moral");
}, 5);
...
DescriptionFunctions["current_unit_globalPassives_luck"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "globalPassives[0].data.stats.luck");
}, 5);
...
DescriptionFunctions["current_unit_globalPassives_mana"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "passives[0].data.sideModifiers[0].heroStat.manaCostBonus");
}, 5);
...
DescriptionFunctions["current_unit_passives_attackPen"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "passives[0].data.stats.attackPen");
}, 5);
...
DescriptionFunctions["current_unit_passives_armorPen"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "passives[0].data.stats.armorPen");
}, 5);
...
DescriptionFunctions["unic_unit_vampirism_passive"] = DescriptionRuntime.memoize(function(ctx) {
  const vampirism = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].selfMechanics[0].values[1]");
...
DescriptionFunctions["current_unit_energyPerTakeDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "energyPerTakeDamage");
}, 5);
...
DescriptionFunctions["current_unit_energyPerRound"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "energyPerRound");
}, 5);
...
DescriptionFunctions["current_unit_energyPerCast"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "energyPerCast");
}, 5);
...
DescriptionFunctions["current_unit_inDmgMods_1_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "inDmgMods.list[0].v");
}, 5);
...
DescriptionFunctions["current_unit_inDmgMods_2_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "inDmgMods.list[1].v");
}, 5);
...
DescriptionFunctions["current_unit_inDmgMods_3_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "inDmgMods.list[2].v");
}, 5);
...
DescriptionFunctions["current_unit_outDmgMods_1_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "outDmgMods.list[0].v");
}, 5);
...
DescriptionFunctions["current_unit_outDmgMods_2_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "outDmgMods.list[1].v");
}, 5);
...
DescriptionFunctions["current_unit_outDmgMods_3_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "outDmgMods.list[2].v");
}, 5);
...
DescriptionFunctions["base_class_caster_energy"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "maxEnergy");
}, 5);
...
DescriptionFunctions["base_class_caster_start_energy"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "startEnergy");
}, 5);
...
DescriptionFunctions["current_unit_ability_perStackBuffDuration_unitsBonusDuration"] = DescriptionRuntime.memoize(function(ctx) {
  const unitsBonusDuration = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.buff.durationPerStack[0]");
...
DescriptionFunctions["current_unit_passive_bonusDamage_base"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.targetMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["current_unit_passive_bonusDamage_perStack"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.targetMechanics[0].values[1]");
}, 5);
...
DescriptionFunctions["current_unit_minStatDamage_alt_05"] = DescriptionRuntime.memoize(function(ctx) {
  const damageMin = DescriptionRuntime.get(ctx.currentUnit, "stats.damageMin");
  const return = (Number(damageMin) || 0) * (Number("0.5") || 0);
}, 5);
...
DescriptionFunctions["current_unit_maxStatDamage_alt_05"] = DescriptionRuntime.memoize(function(ctx) {
  const damageMax = DescriptionRuntime.get(ctx.currentUnit, "stats.damageMax");
  const return = (Number(damageMax) || 0) * (Number("0.5") || 0);
}, 5);
...
DescriptionFunctions["current_unit_minStatDamage_alt_10"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "stats.damageMin");
}, 5);
...
DescriptionFunctions["current_unit_maxStatDamage_alt_10"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "stats.damageMax");
}, 5);
...
DescriptionFunctions["current_unit_minStatDamage_alt_15"] = DescriptionRuntime.memoize(function(ctx) {
  const damageMin = DescriptionRuntime.get(ctx.currentUnit, "stats.damageMin");
  const return = (Number(damageMin) || 0) * (Number("1.5") || 0);
}, 5);
...
DescriptionFunctions["current_unit_maxStatDamage_alt_15"] = DescriptionRuntime.memoize(function(ctx) {
  const damageMax = DescriptionRuntime.get(ctx.currentUnit, "stats.damageMax");
  const return = (Number(damageMax) || 0) * (Number("1.5") || 0);
}, 5);
...
DescriptionFunctions["current_unit_minStatDamage_alt_20"] = DescriptionRuntime.memoize(function(ctx) {
  const damageMin = DescriptionRuntime.get(ctx.currentUnit, "stats.damageMin");
  const return = (Number(damageMin) || 0) * (Number("2") || 0);
}, 5);
...
DescriptionFunctions["current_unit_maxStatDamage_alt_20"] = DescriptionRuntime.memoize(function(ctx) {
  const damageMax = DescriptionRuntime.get(ctx.currentUnit, "stats.damageMax");
  const return = (Number(damageMax) || 0) * (Number("2") || 0);
}, 5);
...
DescriptionFunctions["unic_unit_petSelfHeal"] = DescriptionRuntime.memoize(function(ctx) {
  const unitsBonusStacks = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[2]");
...
DescriptionFunctions["current_unit_vampireAbility1"] = DescriptionRuntime.memoize(function(ctx) {
  const stackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[0]");
...
DescriptionFunctions["current_unit_vampireAbility2"] = DescriptionRuntime.memoize(function(ctx) {
  const stackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[2]");
  return DescriptionRuntime.formatInt(stackDmg);
}, 5);
...
DescriptionFunctions["unic_unit_twinkleManaAbility"] = DescriptionRuntime.memoize(function(ctx) {
  const unitsBonusMana = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[4]");
...
DescriptionFunctions["current_unit_abilityBaseDamage"] = DescriptionRuntime.memoize(function(ctx) {
  const maxStackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.minBaseDmg");
  return DescriptionRuntime.formatInt(maxStackDmg);
}, 5);
...
DescriptionFunctions["current_unit_startTurnDamage_passive"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.buff.sid");
  const buffData = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.minStackDmg");
  return DescriptionRuntime.formatModInt(buffData);
}, 5);
...
DescriptionFunctions["unic_unit_hiveQueenAbility2"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.buff.sid");
  const minStackDmg = DescriptionRuntime.get(GameData.buffs?.[buffSid], "timeoutActions[0].damageDealer.minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(GameData.buffs?.[buffSid], "timeoutActions[0].damageDealer.maxStackDmg");
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const return = Math.floor(Number(stackDmg) || 0);
}, 5);
...
DescriptionFunctions["unic_unit_SchismCalling"] = DescriptionRuntime.memoize(function(ctx) {
  const percent = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[1]");
...
DescriptionFunctions["unic_unit_demon_defence_passive"] = DescriptionRuntime.memoize(function(ctx) {
  const passiveBonus = DescriptionRuntime.get(ctx.currentUnit, "conditionalPassives[0].stats.defence");
...
DescriptionFunctions["unic_unit_demon_offence_passive"] = DescriptionRuntime.memoize(function(ctx) {
  const passiveBonus = DescriptionRuntime.get(ctx.currentUnit, "conditionalPassives[0].stats.offence");
  return DescriptionRuntime.formatModInt(passiveBonus);
}, 5);
...
DescriptionFunctions["unic_unit_demon_anticrit_passive"] = DescriptionRuntime.memoize(function(ctx) {
  const passiveBonus = DescriptionRuntime.get(ctx.currentUnit, "conditionalPassives[1].stats.anticrit");
...
DescriptionFunctions["unic_unit_demon_crit_passive"] = DescriptionRuntime.memoize(function(ctx) {
  const passiveBonus = DescriptionRuntime.get(ctx.currentUnit, "conditionalPassives[1].stats.crit");
  return DescriptionRuntime.formatModPercentNumeric(passiveBonus);
}, 5);
...
DescriptionFunctions["unic_unit_lava_larva_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const fullStacks = DescriptionRuntime.get(ctx.currentUnit, "fullStacks");
  const startStacks = DescriptionRuntime.get(ctx.currentUnit, "startBattleFullStacks");
  const statDmgMult = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.statDmgMult");
  const minBaseDmg = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.maxBaseDmg");
  const minStackDmg = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.maxStackDmg");
  const damageMultiplerPerHeroLevel = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.damageMultiplerPerHeroLevel");
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseDmg = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const heroMultiplier = (Number(heroLevel) || 0) * (Number(damageMultiplerPerHeroLevel) || 0);
  const stackDmgMul = (Number(heroMultiplier) || 0) * (Number(baseDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(stackDmgMul) || 0);
  return DescriptionRuntime.formatModInt(damage);
}, 5);
...
DescriptionFunctions["unic_unit_lava_larva_passive_1_base_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const minBaseDmg = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.minBaseDmg");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.maxBaseDmg");
  const avg = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
  const return = (Number(avg) || 0) * (Number("2") || 0);
}, 5);
...
DescriptionFunctions["unic_unit_lava_larva_passive_2"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDmg = DescriptionFunctions["unic_unit_lava_larva_passive_1"]?.(ctx) ?? null;
  const return = (Number(baseDmg) || 0) * (Number("2") || 0);
}, 5);
...
DescriptionFunctions["unic_unit_trick_demon_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "stats.damagePerDeltaLevel");
}, 5);
...
DescriptionFunctions["unic_unit_locust_ability_1"] = DescriptionRuntime.memoize(function(ctx) {
  const shootRange = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.shootRange");
...
DescriptionFunctions["unic_unit_locust_ability_2"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentAbility, "selfDealer.buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.offence");
}, 5);
...
DescriptionFunctions["unic_unit_wasp_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.buff.duration");
}, 5);
...
DescriptionFunctions["unic_unit_godslayer_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "stats.outDamageIfLevelAbove");
}, 5);
...
DescriptionFunctions["unic_unit_olgoi_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.targetMechanics[0].values[1]");
}, 5);
...
DescriptionFunctions["unic_unit_olgoi_ability_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[0]");
}, 5);
...
DescriptionFunctions["unic_unit_hive_queen_passive_4"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "stats.damagePerDeltaLevelLower");
}, 5);
...
DescriptionFunctions["unic_unit_hive_queen_ability_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[3]");
}, 5);
...
DescriptionFunctions["unic_unit_hive_queen_ability_2"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const maxStackDmg = DescriptionRuntime.get(GameData.buffs?.[buffSid], "timeoutActions[0].damageDealer.maxStackDmg");
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const damage = (Number(currentStacks) || 0) * (Number(stackDmg) || 0);
  const return = Math.floor(Number(damage) || 0);
}, 5);
...
DescriptionFunctions["current_buff_hive_queen_ability_2"] = DescriptionRuntime.memoize(function(ctx) {
  const charges = DescriptionRuntime.get(ctx.currentBuff, "charges");
  const minStackDmg = DescriptionRuntime.get(ctx.currentBuff, "config.timeoutActions[0].damageDealer.minStackDmg");
  const maxStackDmg = DescriptionRuntime.get(ctx.currentBuff, "config.timeoutActions[0].damageDealer.maxStackDmg");
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const damage = (Number(charges) || 0) * (Number(stackDmg) || 0);
  const return = Math.floor(Number(damage) || 0);
}, 5);
...
DescriptionFunctions["unic_unit_trogl_passive_2"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.inAllDmgMod");
}, 5);
...
DescriptionFunctions["unic_unit_trogl_passive_2_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.buff.duration");
}, 5);
...
DescriptionFunctions["unic_unit_assassin_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "stats.crit");
}, 5);
...
DescriptionFunctions["unic_unit_minos_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "stats.additionalActionChanceModifier");
}, 5);
...
DescriptionFunctions["unic_unit_minos_passive_3_1"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentUnit, "passives[1].actions[0].damageDealer.buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.speed");
}, 5);
...
DescriptionFunctions["unic_unit_esquire_passive_2"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "aura.data.stats.inDmgMods.list[0].v");
}, 5);
...
DescriptionFunctions["unic_unit_angel_ability_2"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.statDmgMult");
}, 5);
...
DescriptionFunctions["unic_unit_elem_active"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.maxEnergy");
}, 5);
...
DescriptionFunctions["unic_unit_twinkle_ability_1"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseMana = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[2]");
  const unitsCount = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[3]");
  const unitsBonusMana = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[4]");
  const fullStacksMul = (Number(currentStacks) || 0) * (Number(unitsBonusMana) || 0);
  const fullStacksDiv = (Number(fullStacksMul) || 0) / (Number(unitsCount) || 0);
  const fullStacksDivFloor = Math.floor(Number(fullStacksDiv) || 0);
  const fullStacksMana = (Number(baseMana) || 0) + (Number(fullStacksDivFloor) || 0);
...
DescriptionFunctions["unic_unit_twinkle_ability_2"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["unic_unit_druid_ability_1"] = DescriptionRuntime.memoize(function(ctx) {
  const manaPerEnergy = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[1]");
...
DescriptionFunctions["unic_unit_druid_ability_2"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const buffData = DescriptionRuntime.get(GameData.buffs?.[buffSid], "actions[0].damageDealer.minStackDmg");
  const return = (Number(currentStacks) || 0) * (Number(buffData) || 0);
}, 5);
...
DescriptionFunctions["unic_unit_phoenix_passive_2"] = DescriptionRuntime.memoize(function(ctx) {
  const startStacks = DescriptionRuntime.get(ctx.currentUnit, "startBattleFullStacks");
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const startStacksPerc = (Number(maxStacks) || 0) / (Number(2) || 0);
  const startStacksPercFloor = Math.floor(Number(startStacksPerc) || 0);
  const currentStacks = (Number(startStacksPercFloor) || 0) + (Number(1) || 0);
...
DescriptionFunctions["unic_unit_phoenix_passive_3"] = DescriptionRuntime.memoize(function(ctx) {
  const heal = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.targetMechanics[0].values[2]");
...
DescriptionFunctions["unic_unit_coatl_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentUnit, "stats.maxInComingNegativeBuffDuration");
}, 5);
...
DescriptionFunctions["unic_unit_pet_ability_2"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const unitsBonusStacks = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[2]");
  const fullStacksMul = (Number(currentStacks) || 0) * (Number(unitsBonusStacks) || 0);
...
DescriptionFunctions["unic_unit_pet_ability_2_add"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentAbility, "selfMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["unic_unit_graverobber_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const energy = DescriptionRuntime.get(ctx.currentUnit, "passives[0].actions[0].damageDealer.targetMechanics[0].values[2]");
...
DescriptionFunctions["unic_unit_lich_passive_1"] = DescriptionRuntime.memoize(function(ctx) {
  const heal = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].selfMechanics[0].values[1]");
  return DescriptionRuntime.formatModPercentNumeric(heal);
}, 5);
...
DescriptionFunctions["unic_unit_avatar_of_war_passive_2"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSid = DescriptionRuntime.get(ctx.currentUnit, "passives[4].actions[0].damageDealer.buff.sid");
  const return = DescriptionRuntime.get(GameData.buffs?.[buffSid], "data.stats.offence");
}, 5);
...
DescriptionFunctions["current_unit_vampire_ability_1_1"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[0]");
  const stackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[1]");
  const stackDmgMul = (Number(currentStacks) || 0) * (Number(stackDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(stackDmgMul) || 0);
  return DescriptionRuntime.formatInt(damage);
}, 5);
...
DescriptionFunctions["current_unit_vampire_ability_2_1"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const baseDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[0]");
  const stackDmg = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[1]");
  const stackDmgMul = (Number(baseDmg) || 0) * (Number(currentStacks) || 0);
...
DescriptionFunctions["current_unit_vampire_ability_2_2"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const baseHeal = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[2]");
  const stackHeal = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[3]");
  const stackHealMul = (Number(baseHeal) || 0) * (Number(currentStacks) || 0);
...
DescriptionFunctions["unic_unit_unfrozen_cultist_ability_2"] = DescriptionRuntime.memoize(function(ctx) {
  const counterstrikes = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.targetMechanics[0].values[0]");
...
DescriptionFunctions["unic_unit_frostworm_rider_passive_3"] = DescriptionRuntime.memoize(function(ctx) {
  const magicDamage = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.targetMechanics[0].values[0]");
...
DescriptionFunctions["unic_unit_frostworm_rider_passive_3_duration"] = DescriptionRuntime.memoize(function(ctx) {
  const duration = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.buff.duration");
  return DescriptionRuntime.formatModInt(duration);
}, 5);
...
DescriptionFunctions["unic_unit_succubus_ability_3"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.minDamagePerEnergyLevel");
}, 5);
...
DescriptionFunctions["unic_unit_arbitrator_passive_2"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const currentStacks = (Number(fullStacks) || 0) + (Number(1) || 0);
  const maxStacks = (Number(startStacks) || 0) + (Number(1) || 0);
  const magicDamagePerStack = DescriptionRuntime.get(ctx.currentUnit, "defaultAttacks[0].damageDealer.targetMechanics[0].values[1]");
  const magicDamage = (Number(currentStacks) || 0) * (Number(magicDamagePerStack) || 0);
  return DescriptionRuntime.formatModInt(magicDamage);
}, 5);
...
DescriptionFunctions["unic_unit_arbitrator_ability_1"] = DescriptionRuntime.memoize(function(ctx) {
  const shootRange = DescriptionRuntime.get(ctx.currentAbility, "damageDealer.orderedCastParams[0].distanceFromFirst");
  return DescriptionRuntime.formatInt(shootRange);
}, 5);
...
DescriptionFunctions["current_buff_outDmgMods_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.outDmgMods.list[0].v");
}, 5);
...
DescriptionFunctions["current_buff_inDmgMods_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.inDmgMods.list[0].v");
}, 5);
...
DescriptionFunctions["current_buff_inAllDmgMod_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.inAllDmgMod");
}, 5);
...
DescriptionFunctions["current_buff_outAllDmgMod_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.outAllDmgMod");
}, 5);
...
DescriptionFunctions["current_buff_finalHealingBonusPercent_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.finalHealingBonusPercent");
}, 5);
...
DescriptionFunctions["current_buff_skipActionChanceModifier_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.skipActionChanceModifier");
}, 5);
...
DescriptionFunctions["current_buff_speed_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.speed");
}, 5);
...
DescriptionFunctions["current_buff_speed_param_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "dataConfig.data.stats.speed");
}, 5);
...
DescriptionFunctions["current_buff_stacks"] = DescriptionRuntime.memoize(function(ctx) {
  const return = ctx.currentBuff.getStacks?.() ?? 1;
}, 5);
...
DescriptionFunctions["current_buff_sp"] = DescriptionRuntime.memoize(function(ctx) {
  const return = ctx.currentBuff.getSpellPower?.() ?? 0;
}, 5);
...
DescriptionFunctions["current_buff_sum_min_dmg"] = DescriptionRuntime.memoize(function(ctx) {
  const return = ctx.currentBuff.getSumMinDmg?.() ?? 0;
}, 5);
...
DescriptionFunctions["current_buff_sum_max_dmg"] = DescriptionRuntime.memoize(function(ctx) {
  const return = ctx.currentBuff.getSumMaxDmg?.() ?? 0;
}, 5);
...
DescriptionFunctions["current_buff_dot_dmg"] = DescriptionRuntime.memoize(function(ctx) {
  const minDmg = DescriptionFunctions["current_buff_sum_min_dmg"]?.(ctx) ?? null;
  const maxDmg = DescriptionFunctions["current_buff_sum_max_dmg"]?.(ctx) ?? null;
  const return = ((Number(minDmg) || 0) + (Number(maxDmg) || 0)) / 2;
}, 5);
...
DescriptionFunctions["current_buff_hot_dmg"] = DescriptionRuntime.memoize(function(ctx) {
  const buffStacks = ctx.currentBuff.getStacks?.() ?? 1;
  const buffSP = ctx.currentBuff.getSpellPower?.() ?? 0;
  const baseHeal = DescriptionRuntime.get(ctx.currentBuff, "config.actions[0].damageDealer.targetMechanics[0].values[0]");
  const stackBonus = DescriptionRuntime.get(ctx.currentBuff, "config.actions[0].damageDealer.targetMechanics[0].values[2]");
  const stackHeal = (Number(stackBonus) || 0) * (Number(buffSP) || 0);
  const heal = (Number(baseHeal) || 0) + (Number(stackHeal) || 0);
  const return = (Number(heal) || 0) * (Number(buffStacks) || 0);
}, 5);
...
DescriptionFunctions["current_buff_revenge_damage"] = DescriptionRuntime.memoize(function(ctx) {
  const buffSP = ctx.currentBuff.getSpellPower?.() ?? 0;
  const baseDamage = DescriptionRuntime.get(ctx.currentBuff, "config.actions[0].damageDealer.targetMechanics[0].values[2]");
  const stackBonus = DescriptionRuntime.get(ctx.currentBuff, "config.actions[0].damageDealer.targetMechanics[0].values[3]");
  const stackDamage = (Number(stackBonus) || 0) * (Number(buffSP) || 0);
  const return = (Number(baseDamage) || 0) + (Number(stackDamage) || 0);
}, 5);
...
DescriptionFunctions["current_buff_initiative_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.initiative");
}, 5);
...
DescriptionFunctions["current_buff_offence_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.offence");
}, 5);
...
DescriptionFunctions["current_buff_offence_param_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "dataConfig.data.stats.offence");
}, 5);
...
DescriptionFunctions["current_buff_defence_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.defence");
}, 5);
...
DescriptionFunctions["current_buff_defence_param_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "dataConfig.data.stats.defence");
}, 5);
...
DescriptionFunctions["current_buff_damageMin_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.damageMin");
}, 5);
...
DescriptionFunctions["current_buff_damageMax_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.damageMax");
}, 5);
...
DescriptionFunctions["current_buff_moral_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.moral");
}, 5);
...
DescriptionFunctions["current_buff_luck_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.luck");
}, 5);
...
DescriptionFunctions["current_buff_hp_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.hp");
}, 5);
...
DescriptionFunctions["current_buff_hpPerc_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.hpPerc");
}, 5);
...
DescriptionFunctions["current_buff_maxEnergy_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.maxEnergy");
}, 5);
...
DescriptionFunctions["current_buff_numCounters_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.numCounters");
}, 5);
...
DescriptionFunctions["current_buff_tauntRadius_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.tauntRadius");
}, 5);
...
DescriptionFunctions["current_buff_healthLimitMinPercent_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.healthLimitMinPercent");
}, 5);
...
DescriptionFunctions["current_buff_energyPerRound_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.energyPerRound");
}, 5);
...
DescriptionFunctions["current_buff_energyPerCast_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.data.stats.energyPerCast");
}, 5);
...
DescriptionFunctions["current_buff_mimicStats_param"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.mimicStats[0].bonusFloat");
}, 5);
...
DescriptionFunctions["current_buff_ent_passive"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.currentBuff, "config.actions[0].damageDealer.targetMechanics[0].values[2]");
}, 5);
...
DescriptionFunctions["sentry_ability_baseDmg"] = DescriptionRuntime.memoize(function(ctx) {
  const minBaseDmg = DescriptionRuntime.get(ctx.currentSentry, "config.stats.damageMin");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentSentry, "config.stats.damageMax");
  const baseDmg = ((Number(minBaseDmg) || 0) + (Number(maxBaseDmg) || 0)) / 2;
  return DescriptionRuntime.formatInt(baseDmg);
}, 5);
...
DescriptionFunctions["sentry_ability_damageMultiplierPerBuilding"] = DescriptionRuntime.memoize(function(ctx) {
  const damageMultiplierPerBuilding = DescriptionRuntime.get(ctx.currentSentry, "config.stats.damageMultiplierPerBuilding");
...
DescriptionFunctions["hero_ability_skill_damage_ability"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDmg = DescriptionFunctions["hero_ability_baseDmg"]?.(ctx) ?? null;
  const damageMultiplerPerHeroLevel = DescriptionFunctions["hero_ability_damageMultiplerPerHeroLevel"]?.(ctx) ?? null;
  const heroLevelBase = DescriptionRuntime.get(ctx.currentHero, "level");
  const heroLevel = (Number(heroLevelBase) || 0) - (Number("1") || 0);
  const heroOFF = DescriptionRuntime.get(ctx.currentHero, "heroStat.offence");
  const heroDEF = DescriptionRuntime.get(ctx.currentHero, "heroStat.defence");
  const heroSP = DescriptionRuntime.get(ctx.currentHero, "heroStat.spellPower");
  const heroINT = DescriptionRuntime.get(ctx.currentHero, "heroStat.intelligence");
  const summHeroStat = (Number(heroOFF) || 0) + (Number(heroDEF) || 0) + (Number(heroSP) || 0) + (Number(heroINT) || 0);
  const stackDmg = ((Number(minStackDmg) || 0) + (Number(maxStackDmg) || 0)) / 2;
  const statDmg = ((Number(minStatDmg) || 0) + (Number(maxStatDmg) || 0)) / 2;
  const damageStackBonus = (Number(heroSP) || 0) * (Number(stackDmg) || 0);
  const damageStatBonus = (Number(summHeroStat) || 0) * (Number(statDmg) || 0);
  const damageBase = (Number(baseDmg) || 0) + (Number(damageStatBonus) || 0) + (Number(damageStackBonus) || 0);
  const damageMultipler = (Number(damageMultiplerPerHeroLevel) || 0) * (Number(heroLevel) || 0);
  const damageBonus = (Number(damageMultipler) || 0) * (Number(damageBase) || 0);
  const damage = (Number(damageBase) || 0) + (Number(damageBonus) || 0);
  return DescriptionRuntime.formatInt(damage);
}, 5);
...
DescriptionFunctions["hero_ability_attack_siege_ability"] = DescriptionRuntime.memoize(function(ctx) {
  ...
  const heroSP = DescriptionRuntime.get(ctx.currentHero, "heroStat.spellPower");
  const damageMultipler = (Number(damageMultiplerPerHeroLevel) || 0) * (Number(heroLevel) || 0);
  const damageBonus = (Number(damageMultipler) || 0) * (Number(baseDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(damageBonus) || 0);
  return DescriptionRuntime.formatInt(damage);
}, 5);
...
DescriptionFunctions["hero_ability_attack_siege_tower_ability"] = DescriptionRuntime.memoize(function(ctx) {
  const baseDmg = DescriptionFunctions["sentry_ability_baseDmg"]?.(ctx) ?? null;
  const damageMultiplierPerBuilding = DescriptionFunctions["sentry_ability_damageMultiplierPerBuilding"]?.(ctx) ?? null;
  const minBaseDmg = DescriptionRuntime.get(ctx.currentSentry, "config.stats.damageMin");
  const maxBaseDmg = DescriptionRuntime.get(ctx.currentSentry, "config.stats.damageMax");
  const buildingLevel = ctx.currentCity?.buildingsCount ?? 0;
  const damageMultipler = (Number(damageMultiplierPerBuilding) || 0) * (Number(buildingLevel) || 0);
  const damageBonus = (Number(damageMultipler) || 0) * (Number(baseDmg) || 0);
  const damage = (Number(baseDmg) || 0) + (Number(damageBonus) || 0);
  return DescriptionRuntime.formatInt(damage);
}, 5);
...
DescriptionFunctions["hero_ability_skill_faction_dungeon_ability"] = DescriptionRuntime.memoize(function(ctx) {
  const buffData = DescriptionRuntime.get(GameData.sidebuffs?.[buffSid], "actions[0].damageDealer.buff.sid");
  const skillData = DescriptionRuntime.get(GameData.buffs?.[buffData], "data.stats.offence");
...
DescriptionFunctions["hero_ability_sub_skill_faction_undead_5_ability"] = DescriptionRuntime.memoize(function(ctx) {
  const heroSP = DescriptionRuntime.get(ctx.currentHero, "heroStat.spellPower");
  const healStackBonus = (Number(heroSP) || 0) * (Number(perStackHeal) || 0);
  const heal = (Number(baseHeal) || 0) + (Number(healStackBonus) || 0);
  return DescriptionRuntime.formatInt(heal);
}, 5);
...
DescriptionFunctions["current_law_modPercent_bonuses_0_parameters_0"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[0].parameters[0]");
...
DescriptionFunctions["current_law_modPercent_bonuses_0_parameters_1"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[0].parameters[1]");
  return DescriptionRuntime.formatModPercentNumeric(lawData);
}, 5);
...
DescriptionFunctions["current_law_modPercent_bonuses_0_parameters_2"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[0].parameters[2]");
  return DescriptionRuntime.formatModPercentNumeric(lawData);
}, 5);
...
DescriptionFunctions["current_law_modPercent_bonuses_0_parameters_3"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[0].parameters[3]");
  return DescriptionRuntime.formatModPercentNumeric(lawData);
}, 5);
...
DescriptionFunctions["current_law_modPercent_bonuses_1_parameters_0"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[1].parameters[0]");
  return DescriptionRuntime.formatModPercentNumeric(lawData);
}, 5);
...
DescriptionFunctions["current_law_modPercent_bonuses_1_parameters_1"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[1].parameters[1]");
  return DescriptionRuntime.formatModPercentNumeric(lawData);
}, 5);
...
DescriptionFunctions["current_law_modPercent_bonuses_1_parameters_2"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[1].parameters[2]");
  return DescriptionRuntime.formatModPercentNumeric(lawData);
}, 5);
...
DescriptionFunctions["current_law_modPercent_bonuses_1_parameters_3"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[1].parameters[3]");
  return DescriptionRuntime.formatModPercentNumeric(lawData);
}, 5);
...
DescriptionFunctions["current_law_modInt_bonuses_2_parameters_0"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[2].parameters[0]");
  return DescriptionRuntime.formatModInt(lawData);
}, 5);
...
DescriptionFunctions["current_law_modInt_bonuses_2_parameters_1"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[2].parameters[1]");
  return DescriptionRuntime.formatModInt(lawData);
}, 5);
...
DescriptionFunctions["current_law_modInt_bonuses_3_parameters_1"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[3].parameters[1]");
  return DescriptionRuntime.formatModInt(lawData);
}, 5);
...
DescriptionFunctions["current_law_modInt_bonuses_0_upgrade_increment"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[0].upgrade.increment");
  return DescriptionRuntime.formatModInt(lawData);
}, 5);
...
DescriptionFunctions["current_law_modInt_bonuses_0_upgrade_levelStep"] = DescriptionRuntime.memoize(function(ctx) {
  const lawData = DescriptionRuntime.get(ctx.currentLaw, "bonuses[0].upgrade.levelStep");
  return DescriptionRuntime.formatModInt(lawData);
}, 5);
...
DescriptionFunctions["test_subquest_current_value"] = DescriptionRuntime.memoize(function(ctx) {
  const currentCounterValue = ctx.questCounters?.["gold_piles_collected"] ?? 0;
...
DescriptionFunctions["test_subquest_goal_value"] = DescriptionRuntime.memoize(function(ctx) {
  const goalValue = DescriptionRuntime.get(ctx.currentQuest, "");
...
DescriptionFunctions["test_subquest_left_to_kill"] = DescriptionRuntime.memoize(function(ctx) {
  const leftToKill = DescriptionRuntime.get(ctx.currentQuest, "");
...
DescriptionFunctions["M2_Q2_tethers_cleared"] = DescriptionRuntime.memoize(function(ctx) {
  const currentCounterValue = ctx.questCounters?.["tethers_visited"] ?? 0;
  return DescriptionRuntime.formatInt(currentCounterValue);
}, 5);
...
DescriptionFunctions["tutorial_C2_1"] = DescriptionRuntime.memoize(function(ctx) {
  const value = DescriptionRuntime.get(ctx.currentSide, "crystals");
...
DescriptionFunctions["map_object_test_gold"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.eventBank, "rewardSet.rewards[0].parameters[1]");
}, 5);

// Source: DB/info/concept.script:57
DescriptionFunctions["map_object_test_gem"] = DescriptionRuntime.memoize(function(ctx) {
  const return = DescriptionRuntime.get(ctx.eventBank, "rewardSet.rewards[0].parameters[3]");
}, 5);

// Source: DB/info/concept.script:71
DescriptionFunctions["text_red_damage_with_icon"] = DescriptionRuntime.memoize(function(ctx) {
  const r = "<icon=damage><color=red>[sid_from_locale]<color>";
  return null;
}, 5);

// Source: DB/info/concept.script:77
DescriptionFunctions["unit_a1_value"] = DescriptionRuntime.memoize(function(ctx) {
  const damage = Number("ability.1.damage") || 0;
  const r = (Number(damage) || 0) * (Number(damageMultipler) || 0);
  const r = (Number(r) || 0) * (Number(meleDamageMultiler) || 0);
  const r = (Number(r) || 0) + (Number(flatDamage) || 0);
  return null;
}, 5);
...
DescriptionFunctions["unit_a1_alt"] = DescriptionRuntime.memoize(function(ctx) {
  const damage = Number("ability.1.damage") || 0;
  const r = (Number(r) || 0) + (Number(flatDamage) || 0);
  const t = "{r} = {damage} * {damageMultipler}";
  return null;
}, 5);

// Source: DB/info/concept.script:118
DescriptionFunctions["unit_a1_text"] = DescriptionRuntime.memoize(function(ctx) {
  const textPrefix = DescriptionFunctions["text_red_damage_with_icon"]?.(ctx) ?? null;
  const value = DescriptionFunctions["unit_a1_value"]?.(ctx) ?? null;
  const r = "{textPrefix}<color=red>{value}<color>";
  return null;
}, 5);
